...
Use `/device-adapter` commands when the user wants to create a device context, package project files, build Docker artifacts, deploy to a remote board, run remote tests, collect logs, or iterate on deployment/runtime failures.
